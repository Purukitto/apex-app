  ...
  group('ApexButton', () {
    testWidgets('renders label text', (tester) async {
      await tester.pumpWidget(
        buildTestApp(
          child: ApexButton(label: 'Click Me', onPressed: () {}),
        ),
      );
    ...
    testWidgets('calls onPressed when tapped', (tester) async {
      ...
      await tester.pumpWidget(
        buildTestApp(
          child: ApexButton(label: 'Tap', onPressed: () => pressed = true),
        ),
      );
    ...
    testWidgets('does not call onPressed when null', (tester) async {
      await tester.pumpWidget(
        buildTestApp(
          child: const ApexButton(label: 'Disabled', onPressed: null),
        ),
      );
    ...
    testWidgets('renders filled variant by default', (tester) async {
      await tester.pumpWidget(
        buildTestApp(
          child: ApexButton(label: 'Filled', onPressed: () {}),
        ),
      );
