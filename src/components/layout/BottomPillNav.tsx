...
export default function BottomPillNav() {
  ...
  return (
    <AnimatePresence>
      {!shouldHide && (
        <motion.div
          className="fixed left-1/2 -translate-x-1/2 z-50 bg-apex-white/10 backdrop-blur-xl border border-apex-white/10 shadow-(--shadow-apex-card) rounded-full flex items-center pointer-events-auto"
          style={{
